...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h1>Step №4 <small>Installation Complete</small></h1>
			<p>Congratulations! Installation is complete, to start working, delete or rename the directory <code>install</code>.</p>
			<p><a href="<?=get_url('')?>" class="btn btn-success btn">Continue</a></p>
		</div>
	</div>
</div>
<!-- scripts -->
